      ...
      <div className="py-8 mx-auto max-w-7xl">
        ...
        >
          <nav className="flex items-center mb-4 space-x-2 text-blue-300">
            ...
            <span>›</span>
            <span className="text-white">Książki</span>
          </nav>
          <h1 className="text-3xl font-bold text-white md:text-4xl">📚 Książki</h1>
        </motion.div>

        <GlassCard className="p-8 text-center">
          <div className="mb-4 text-6xl">🚧</div>
          <h2 className="mb-4 text-2xl font-bold text-white">Wkrótce dostępne!</h2>
          <p className="text-blue-100">Sekcja Książki jest w trakcie przygotowania.</p>
        </GlassCard>
      </div>
    </div>
  );
